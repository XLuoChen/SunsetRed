    ...
    return <div className="col-md-6 col-md-offset-3">
      <div className="panel panel-primary ">
        <div className="panel-heading">
          <center>
            <h1 className="panel-title ">日记主题：{this.props.diaryContent.title}&nbsp;&nbsp;&nbsp;&nbsp;
              <small>昵称：{this.props.diaryContent.name}</small>
            </h1>
          </center>
        </div>
        日记内容:
        <textarea className="panel-body" style={{'minHeight': '450px', minWidth: '100%'}}
